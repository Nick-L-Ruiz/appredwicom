...
class EvidenciaMecanicaScreenAdmin extends StatefulWidget {
  const EvidenciaMecanicaScreenAdmin({super.key});

  @override
  State<EvidenciaMecanicaScreenAdmin> createState() => _EvidenciaMecanicaScreenAdminState();
}

class _EvidenciaMecanicaScreenAdminState extends State<EvidenciaMecanicaScreenAdmin> {
